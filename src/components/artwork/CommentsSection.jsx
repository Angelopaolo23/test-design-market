 ...
 *
 * Envuelta en GlassSurface para separación visual del background.
 *
 * @param {Object} props
    ...
    >
      ...
      {can_comment && (
        <form onSubmit={handle_submit} className="mb-6">
          <div className="flex gap-3 p-4 rounded-lg bg-white/5 border border-raios-text-support/10">
      ...
      {comments.length === 0 ? (
        ...
        <div className="space-y-4">
          {comments.map((comment) => (
            <div
              key={comment.id}
              className="flex gap-3 p-4 rounded-lg bg-white/5 border border-raios-text-support/10"
            >
              {/* Avatar */}
